...
function getCriteria(){
  var num = confirm("Press OK if you would like your password to contain numbers.");
  var lower = confirm("Press OK for lower case letters in your password");
  var upper = confirm("Press OK for upper case letters in your password.");
  var special = confirm("Press OK for special characters in your password.");
